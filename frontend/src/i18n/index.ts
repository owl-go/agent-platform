...
const messages = {
  "zh-CN": {
    ...
    operations: {
      ...
      controlKicker: "受控干预", controls: "Run Operator 操作", controlBoundary: "Operator 只能中断、取消、紧急终止或恢复明确的基础设施失败；不能 Resume 或代批 Approval。", reason: "安全原因", reasonHint: "Kill 和恢复必须填写 3–500 字的可审计原因", interrupt: "Interrupt", cancel: "Cancel", kill: "Kill", recover: "恢复基础设施失败", killConfirm: "Kill 会立即终止 Attempt 并释放 Lease，确认继续？", notRecoverable: "此失败不是可恢复的基础设施故障。",
      auditKicker: "治理证据", audit: "Audit Event", actor: "执行者 User ID", operation: "操作", resource: "资源类型", outcome: "结果", succeeded: "成功", failed: "失败", searchAudit: "查询 Audit", loadingAudit: "正在读取 Audit Event", safeMetadata: "安全元数据", noAudit: "当前筛选条件下没有 Audit Event。"
    },
  ...
  "en-US": {
    ...
    operations: {
      ...
      controlKicker: "CONTROLLED INTERVENTION", controls: "Run Operator actions", controlBoundary: "Operators may interrupt, cancel, kill, or recover an explicit infrastructure failure. They cannot Resume or decide Approvals.", reason: "Safety reason", reasonHint: "Kill and recovery require an auditable reason of 3–500 characters", interrupt: "Interrupt", cancel: "Cancel", kill: "Kill", recover: "Recover infrastructure failure", killConfirm: "Kill immediately terminates the Attempt and releases its Leases. Continue?", notRecoverable: "This failure is not an eligible infrastructure failure.",
      auditKicker: "GOVERNANCE EVIDENCE", audit: "Audit Events", actor: "Actor User ID", operation: "Operation", resource: "Resource type", outcome: "Outcome", succeeded: "Succeeded", failed: "Failed", searchAudit: "Search Audit", loadingAudit: "Loading Audit Events", safeMetadata: "Safe metadata", noAudit: "No Audit Events match these filters."
    },
