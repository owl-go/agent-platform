...
import { platformApiKey, type CLIConnectorDefinition, type CLIConnectorDefinitionInput, type CLIConnectorEnablement, type EnvironmentVariable, type MCPServer, type Skill } from "../api/client";
