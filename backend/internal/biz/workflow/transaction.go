...
type ExecutionCommands interface {
	...
	Control(context.Context, string, int64, executiondomain.ControlAction, string, string, time.Time) (executiondomain.Details, executiondomain.CompletionProjection, error)
