...
- Artifacts are grouped by Run time. A terminal response with generated or changed files shows compact `View all artifacts` and `View all changes` controls; the controls expand downloadable file cards and redacted text previews respectively.
